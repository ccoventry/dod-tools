...
| **E4** | 🟢 **Easy** | **Chat Formatting: Spacing Trim** | GUI / Chat Log | Clean up extra padding and spaces (e.g., trim multiple spaces around nicknames and colons). | Refactor `native/src/bin/gui/views/chat.rs` text rendering/splitting to trim redundant spaces around nicknames and delimiters. |
