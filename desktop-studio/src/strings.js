...
export const STRINGS = {
  ...
  CAPTURE_CONFIG: {
    ...
    PRE_ROLL_TITLE: 'Time between fast-forward stopping and capture starting.',
    POST_ROLL_LABEL: 'Post-roll (s):',
    POST_ROLL_TITLE: 'Time between capture stopping and fast-forward resuming.',
    START_LEAD_LABEL: 'Start Lead (s):',
    START_LEAD_TITLE: 'Time between capture starting and the first kill.',
    STOP_TRAIL_LABEL: 'Stop Trail (s):',
    STOP_TRAIL_TITLE: 'Time between the last kill and capture stopping.',
    INITIAL_DELAY_LABEL: 'Initial Delay (s):',
    INITIAL_DELAY_TITLE: 'How long each demo plays at real speed after loading before fast-forwarding toward the first clip begins.',
